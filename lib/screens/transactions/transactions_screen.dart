        ...
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _buildFilterChip('Money In', 1, color: AppColors.credit),
                    const SizedBox(width: 8),
                    _buildFilterChip('Money Out', 2, color: AppColors.debit),
                  ],
                ),
              ],
            ),
          ...
          Expanded(
            child: banking.isLoading && banking.transactions.isEmpty
                ? const Padding(padding: EdgeInsets.all(20), child: ShimmerList(itemCount: 10))
                : RefreshIndicator(
                    onRefresh: () async {
                      if (banking.user != null) await banking.loadTransactions(banking.user!.uid);
                    },
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Column(
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.only(bottom: 12.0, top: index == 0 ? 0 : 16.0),
                                    child: Text(
                                      groupName,
                                  ...
                                  ...txs.map((t) => TransactionTile(transaction: t, showDate: groupName == 'This Week' || groupName == 'Today' || groupName == 'Yesterday' ? false : true)),
                                ],
                              );
                            },
                          ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? (color?.withValues(alpha: 0.12) ?? AppColors.primary.withValues(alpha: 0.12)) : AppColors.surface,

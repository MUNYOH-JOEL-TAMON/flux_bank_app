...
class _TransferScreenState extends State<TransferScreen> {
  ...
  void _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await banking.transfer(
        ...
        toName: 'Simulated Recipient', // In a real app, this would be looked up
        amount: amount,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transfer Money', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
      ...
      body: SafeArea(
        child: AnimatedSwitcher(
          ...
          child: _isSuccess ? _buildSuccess(context) : _buildForm(context, banking),
        ),
      ),
    );
  }
          ...
          children: [
            ...
            FluxTextField(
              ...
              validator: (val) {
                ...
                if (amount > banking.balance) return 'Insufficient balance';
                return null;
              },
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.check_circle_outline, color: AppColors.credit, size: 60),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildReceiptRow('Amount', 'XAF ${_amountController.text}'),
                  const SizedBox(height: 12),
                  _buildReceiptRow('To', _accountController.text),
                  const SizedBox(height: 12),
                  _buildReceiptRow('Date', DateTime.now().toString().substring(0, 16)),
                ],
              ),
